...
Source0  : http://avahi.org/download/avahi-0.7.tar.gz
Source1  : avahi.tmpfiles
Summary  : Avahi Multicast DNS Responder (GLib Support)
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1571693831
...
cp %{_builddir}/avahi-0.7/LICENSE %{buildroot}/usr/share/package-licenses/avahi/9a1929f4700d2407c70b507b3b2aaf6226a9543c
%make_install
%find_lang avahi
